...
class TourForm(FlaskForm):
    ...
    start_date = DateField("Tour Starts at (YYYY-MM-DD): ",format='%Y-%m-%d', validators=[validators.InputRequired()])
    end_date = DateField("Tour Ends at (YYYY-MM-DD): ",format='%Y-%m-%d',validators=[validators.InputRequired()])
